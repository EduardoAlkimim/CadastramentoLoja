...
export const createItem = async (req, res) => {
  try {
    ...
    const [result] = await db.query(sql, [nome, descricao, tagsString, imagem_url]); // 👈 db.query e NÃO pool.query
